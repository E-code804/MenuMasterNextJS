...
export async function PATCH(req, { params }) {
  ...
  //   await Restaurant.findOne({ _id: id, "user_reviews.revId": id2 })
  ...
  //             numReviews;
  //           Restaurant.findByIdAndUpdate(id, { rating: newRating.toString() });
  //           console.log("Updated1");
  //         } else {
  //           return NextResponse.json(
  //             { error: "Review with the given review ID not found." },
  //             { status: 404 }
  //           );
  //         }
  //       } else {
  //         return NextResponse.json(
  //           { error: "Bad restaurant ID." },
  //           { status: 404 }
  //         );
  //       }
  //     })
